...
impl Default for SimulationConfig {
    fn default() -> Self {
        Self {
            ...
            energy_drain_per_tick: 0.0012,
            energy_gain_from_kill: 0.24,
            energy_gain_from_food: 0.48,
            initial_energy: 0.36,
            max_energy: 2.0,
            ...
            max_age: 10000,
            mutation_rate: 0.24,
            weight_mutation_power: 0.24,
            add_node_rate: 0.06,
            add_connection_rate: 0.96,
            delete_connection_rate: 0.00000006,
            max_hidden_nodes: 1200,
            max_ticks: 0,
            compatibility_threshold: 300.0,
            compatibility_min_normalization: 10000.0,
            c1_excess: 1.0,
            c2_disjoint: 1.0,
            c3_weight: 0.4,
            seed: 67,
            report_interval_ticks: 100,
        }
    }
}
